                ...
                <div className="nk-entry-wrap pt-3 ps-lg-5">
                  <div className="nk-entry">
                    ...
                    <div className="pb-5">
                      ...
                      <p className="fs-16">
                        www.tradingmaterials.com offers a 30-day return policy
                        for most items purchased from the Website, with the
                        exception of items marked as “Wrong items in Order”. If
                        you wish to return an item, please contact us within 30
                        days of your purchase. We will provide you with a return
                        shipping label and instructions on how to return the
                        item.
                      </p>
                    </div>
                    <div className="pb-5">
