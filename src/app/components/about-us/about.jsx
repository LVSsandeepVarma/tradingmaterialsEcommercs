                        ...
                        <div className="col-xl-7">
                            <div className="nk-section-head text-center"><span className="nk-section-subtitle" data-aos="fade-up" data-aos-delay="0">Our Story</span>
                                ...
                                <ul className="nk-btn-group justify-content-center pt-5">
                                    <li data-aos="fade-up" data-aos-delay="150"><a href={`${userLang}/login`} className="btn btn-lg btn-primary">Join Our Team</a></li>
                                    <li data-aos="fade-up" data-aos-delay="200"><a href={`${userLang}/contact`} className="btn  btn-lg btn-outline-primary">Our Values</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                                ...
                                <div className="nk-video-inner">
                                    <div className="nk-video-logo p-4 text-left">
                                        <a href={`${userLang}/`} className="logo-link">
                                            <div className="logo-wrap text-start"><img className="logo-img" src="/images/tm-logo-1.png" alt="brand-logo" /></div>
                                        </a>
                                    </div>
                            ...
                            <div className="d-flex flex-column" data-aos="fade-up" data-aos-delay="300">
                                ...
                                <div className="nk-section-head pb-0"><span className="nk-section-subtitle">The journey</span>
                                    ...
                                    <ul className="nk-btn-group pt-5">
                                        <li><a href={`${userLang}/login`} className="btn btn-primary">Join Our Team</a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                    ...
                    <div className="row justify-content-center">
                        <div className="col-lg-8 col-xxl-6">
                            <div className="nk-section-head text-center"><span className="nk-section-subtitle">team members</span>
                                ...
                                <ul className="nk-btn-group justify-content-center pt-5">
                                    <li><a href={`${userLang}/login`} className="btn btn-primary btn-lg">Join Our Team</a></li>
                                    <li><a href={`${userLang}/contact`} className="btn btn-outline-primary btn-lg">Learn More</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                        ...
                        <div className="card card-gutter-lg bg-primary is-theme h-100" data-aos="fade-up" data-aos-delay="0">
                            <div className="card-body p-5 p-md-7">
                                <div className="card-content h-100 d-flex flex-column justify-content-between">
                                    ...
                                    <div><a href="#" className="btn-link"><span>Read More</span><em className="icon ni ni-arrow-right"></em></a></div>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div className="container">
                    <div className="nk-cta-wrap bg-primary-gradient rounded-3 is-theme p-5 p-lg-7" data-aos="fade-up" data-aos-delay="100">
                        <div className="row g-gs align-items-center">
                            ...
                            <div className="col-lg-4 text-center text-lg-end"><a href={`${userLang}/contact`} className="btn btn-white fw-semiBold">Contact Support</a></div>
                        </div>
                    </div>
                </div>
            </section>
