...
export default function ClientCodVerify({ props }) {
  ...
  const [clientToken, setClientToken] = useState(
    sessionStorage.getItem("tempClientToken")
  );
        ...
        <section className="nk-section nk-section-job-details pt-lg-0">
          <div className="container">
            <div className="nk-section-content row px-lg-5">
              <div className="col-12 text-center flex justify-center h-fit  sm:py-2 container"></div>
