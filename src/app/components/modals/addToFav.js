          ...
          <div className="p-2 !rounded bg-white">
            <div className="flex justify-between items-center pb-2">
              <div className="">
                ...
                {modalMessage?.search("cart") !== -1 && wishMsg == true && (
                  <p className="!pt-2 ms:!pt-0 text-xs sm:text-sm flex justify-center items-center pl-3">
                    <BsExclamationCircle
                      color="green"
                      style={{ color: "red" }}
                      className="mr-1"
              ...
              <img src="/images/favicon.webp" width={75} />
            </div>
            <div className="flex justify-center ">
              <img
                src={addedToFavImg}
                style={{ width: "76%", objectFit: "cover" }}
                alt="product"
              />
            </div>
          </div>
