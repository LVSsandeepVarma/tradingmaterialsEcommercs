    ...
    <Modal show={showModal} onHide={closeModal} className="!border-0" centered>
          <Modal.Body className="border-0 !bg-[#e5e7eb]">
            ...
            <div className="flex justify-around min-h-[20vh] items-center pl-2">
              ...
              { wishMsg == true && <p className="flex text-lg items-center !truncate !text-[rgba(105,110,119,1)] p-2 pt-1"><BsExclamationCircle color="green" style={{color:"red"}} className="mr-1" />Removed from your wishlist</p>}
              {/* </div> */}
              </div>
            </div>
            </>
