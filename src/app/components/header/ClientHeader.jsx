...
export default function ClientHeader() {
  ...
  const getUserInfo = async () => {
    ...
    } else if (sessionStorage.getItem("tempClientToken")) {
      try {
        const response = await axios.get(
          "https://admin.tradingmaterials.com/api/client/get-user-info",
          {
  ...
  async function handleLogout() {
    try {
      ...
      if (response?.status) {
        dispatch(logoutUser());
        sessionStorage.removeItem("tempClientToken");
        dispatch(updateNotifications({ type: "", message: "" }));
        window.location.href = `${urlConstants.client}/`;
                ...
                <div className="container">
                  <div className="nk-header-wrap">
                    <div className="nk-header-logo">
                      <a href={`${urlConstants.client}/`} className="logo-link">
                    ...
                    >
                      <div>
                        <ul className="nk-nav">
                          ...
                          <li className="nk-nav-item">
                            <a
                              href={`${urlConstants.client}/products`}
                              className={`nk-nav-link ${
                                location.pathname === "/products"
                                  ? "active"
                                  : ""
                            ...
                            <a
                              href={
                                userData?.order_placed_count != 0
                                  ? `${urlConstants.client}/view-order/placed`
                                  : userData?.order_confirmed_count != 0
                                  ? `${urlConstants.client}/view-order/confirmed`
                                  : userData?.order_dispatched_count != 0
                                  ? `${urlConstants.client}/view-order/dispatched`
                                  : userData?.order_delivered_count != 0
                                  ? `${urlConstants.client}/view-order/delivered`
                                  : `${urlConstants.client}/view-order/placed`
                              }
                          ...
                          {isLoggedIn && (
                            <li className="nk-nav-item">
                              <a
                                href={`${urlConstants.client}/profile`}
                                className={`nk-nav-link ${
                          ...
                          <li className="nk-nav-item">
                            <a
                              href={`${urlConstants.client}/invoices`}
                              className={`nk-nav-link ${
                          ...
                          {(sessionStorage.getItem("tempClientToken") || token) && (
                          ...
                          {(sessionStorage.getItem("tempClientToken") == null && !token) && (
