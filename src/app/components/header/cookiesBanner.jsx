...
const CookieBanner = ({storeResponse}) => {
  ...
  const handleDecline = () => {
    ...
    localStorage.setItem("cookieDeclienedTime", new Date().toLocaleDateString())
    setResponded(true);
    storeResponse()
  };
  console.log();
    ...
    <div>
      ...
      >
        ...
        <Stack direction="row" spacing={2}>
          <Button className="hover:shadow" variant="outlined" onClick={handleAccept}>
            Accept
          </Button>
          <Button className="hover:shadow" variant="outlined" onClick={handleDecline}>
            Decline
          </Button>
        </Stack>
      </Box>
