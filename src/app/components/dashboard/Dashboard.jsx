          ...
          <section className="nk-section ">
            ...
            <div className="container">
              <div className="row gy-5 gy-xl-0">
                <div
                  className="col-md-3 col-xl-3 justify-content-center"
                  data-aos="fade-up"
                  data-aos-delay="150"
                >
                  <div className="left-side-bar ">
                    <div className="profiles  drop-shadow-lg justify-content-center">
                      {userData == {} && (
                    ...
                    <div className="last-login justify-content-center ">
                      <h4>
                        Last Login:{" "}
                        <span>
                    ...
                    <div className="activitys !max-h-[480px] overflow-y-auto ">
                    ...
                    {orders ?.map((order,ind)=>{
                      if(new Date(order?.created_at).getMonth === new Date()?.getMonth){
                        ...
                        <div key={ind} className="">
                         {ind != 0 && <div className="act-col"><span className="vl"></span></div>}
                          <div className="act-col">
                      <div className="left-c"><span>Order Placed:</span></div>
                      <div className="right-c"><span>{new Date(order?.created_at).toLocaleDateString('en-US', { day: '2-digit', month: 'short', year: 'numeric' })}</span></div>
                    </div>
                    <div className="act-col">
                      ...
                      <div className="right-c"><span>29 Aug 2023</span></div>
                    </div>
                ...
                >
                  {/* <div className="row">
                    ...
                    <div className="col-lg-4">
                      <div className="card shadow border-0 px-3 m-[10px]">
                        <div className="card-body">
                          <div className="d-flex justify-content-between align-items-center db-cards">
                            <div className="">
                              <h3 className="mb-0 !font-bold text-muted text-[16px]">
                                Order Placed
                              </h3>
                              <h5 className="mb-0 mt-1! text-[16px]  !font-bold text-start text-muted">
