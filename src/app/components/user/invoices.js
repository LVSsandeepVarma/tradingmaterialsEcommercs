...
export default function Invoices() {
  ...
  return (
    <>
      ...
      {showModal && (
        <ViewOrderModal show={showModal} onHide={hideModal} orderId={orderId} />
      )}
            ...
            <div className="container">
              <div className="row">
                <div className="col-lg-8 col-xxl-5">
                  <div>
                    <a href="product-details.php" className="btn-link mb-2">
                      ...
                      <thead className="table-success">
                        <tr>
                          <th>
                            SHIP TO
                            <br />
                            <span className="th-tex">
                              B 12, Shop No2, Mukherjee Nagar, Delhi, India
                            </span>
                          </th>
                          <th>
                            SHIP TO PINCODE
                            <br />
                            <span className="th-tex">110009</span>
                          </th>
                          <th>
                            DELIVERY STATUS
                            <br />
                            <span className="th-tex">Ready To Deliver</span>
                          </th>
                          <th>
                            ORDER ID
                            <br />
                            <span className="th-tex">123-45678</span>
                          </th>
                          <th>INVOICE</th>
                        </tr>
                      </thead>
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td colSpan="3" className="td-btn-center">
                            <a
                              href="#"
                              className="btn btn-outline-dark border w-100 mt-4 margin-space"
                            >
                              <span style={{ fontSize: "14px" }}>
                                Shipped To
                              </span>
                      ...
                      <thead className="table-success">
                        <tr>
                          ...
                          <th>
                            SHIP TO PINCODE
                            <br />
                            <span className="th-tex">560041</span>
                          </th>
                          <th>
                            DELIVERY STATUS
                            <br />
                            <span className="th-tex">Ready To Pack</span>
                          </th>
                          <th>
                            ORDER ID
                            <br />
                            <span className="th-tex">456-78900</span>
                          </th>
                          <th>INVOICE</th>
                        </tr>
                      </thead>
                        ...
                        <tr>
                          ...
                          <td>
                            <table>
                              <tr>
                                <td className="td-text-1">
                                  Candlestick Chart Patterns Posters – Volume 1
                                </td>
                              </tr>

                              <tr>
                                <td className="td-text-2">
                                  Return eligible through 22-July-2023
                                </td>
                              </tr>
                      ...
                      <thead className="table-success">
                        <tr>
                          <th>
                            ...
                            <br />
                            <span className="th-tex">
                              Shop No8, Manas Soc, Sec No 6, Airoli, Navi
                              Mumbai, India
                            </span>
                          </th>
                          <th>
                            SHIP TO PINCODE
                            <br />
                            <span className="th-tex">400708</span>
                          </th>
                          <th>
                            DELIVERY STATUS
                            <br />
                            <span className="th-tex">Product Replacement</span>
                          </th>
                          <th>
                            ORDER ID
                            <br />
                        ...
                        <tr>
                          ...
                          <td>
                            <table>
                              <tr>
                                <td className="td-text-1">
                                  Pack of 4: Book & Journal & Trading Cards and
                                  Mouse Pad
                                </td>
                              </tr>
                              ...
                              <tr>
                                <td className="td-text-2">
                                  Return eligible through 09-Aug-2023
                                </td>
                              </tr>
                        ...
                        <div className="col-lg-7 ps-lg-0">
                          ...
                          <div className="d-flex align-items-center justify-content-between">
                            <p className="fs-18 m-0 text-gray-1200 fw-bold">
                              {" "}
                              $44.00 -{" "}
                              <del className="text-gray-800">$85.00</del>
                            </p>
                          </div>
                        ...
                        <div className="col-lg-7 ps-lg-0">
                          ...
                          <div className="d-flex align-items-center justify-content-between">
                            <p className="fs-18 m-0 text-gray-1200 fw-bold">
                              {" "}
                              $45.00 -{" "}
                              <del className="text-gray-800">$95.00</del>
                            </p>
                          </div>
