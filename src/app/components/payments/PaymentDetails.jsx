      ...
      <div className="card" data-aos="fade-up">
        ...
        <div className="card-body !p-0">
            ...
            <div
              ...
              id="nav-tabContent"
            >
              <div className="card shadow-md drop-shadow-md" data-aos="fade-up">
                {/* <div
                          ...
                          if (activeTab == 1 && payment?.status == "1") {
                              ...
                              >
                                ...
                                >
                                  {/* <h2 className="panel-title !p-0 !m-0 "> */}
                                    <button
                                      className={`accordion-button accordion-success ${
                                        activeOrderId != payment?.order_id ? "collapsed" : ""
                                      }`}
                                      role="button"
                            ...
                            return (
                              ...
                              >
                                ...
                                >
                                  <p
                                    className={`accordion-button accordion-failed  ${
                            activeOrderId != payment?.order_id
                                        ? "collapsed"
                                        : ""
                                    }`}
                            ...
                            return (
                              ...
                              >
                                ...
                                >
                                  {/* <h2 className="panel-title !p-0 !m-0 "> */}
                                    <button
                                      className={`accordion-button accordion-pending ${
                                        activeOrderId != payment?.order_id
                                          ? "collapsed"
                                          : ""
                                      }`}
